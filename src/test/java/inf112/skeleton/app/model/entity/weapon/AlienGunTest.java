...
public class AlienGunTest {
    ...
    @Test
    public void testAlienGun() {
        initApplication();
        init();
        Player player = new Player(new Vector2(2, 2));
        AlienGun alienGun = new AlienGun(player.getPhysicalBody(), player.getOwnerType());
        assertNotNull(alienGun);
    }

    @Test
    public void testAlienGunFire() {
        initApplication();
        init();
        Box2DWorldStatic.startBox2DWorld();
        Player player = new Player(new Vector2(2, 2));
        AlienGun alienGun = new AlienGun(player.getPhysicalBody(), player.getOwnerType());
        alienGun.attack(new Vector2(1,0));
        Bullet bullet = null;
